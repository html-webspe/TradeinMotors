(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper1")) new Swiper(".swiper1", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            const heroSlider = document.querySelector(".hero-main__slider");
            if (heroSlider) {
                const prevControl = heroSlider.querySelector(".slider__control-prev");
                const nextControl = heroSlider.querySelector(".slider__control-next");
                const pagination = heroSlider.querySelector(".slider__pagination");
            ...
            if (carSlider) {
                const prevControl = carSlider.querySelector(".slider__control-prev");
                const nextControl = carSlider.querySelector(".slider__control-next");
                const pagination = carSlider.querySelector(".slider__pagination");
            ...
            if (teamSlider) {
                const prevControl = teamSlider.querySelector(".slider__control-prev");
                const nextControl = teamSlider.querySelector(".slider__control-next");
                const pagination = teamSlider.querySelector(".slider__pagination");
        ...
        function headerScroll() {
            ...
            document.addEventListener("windowScroll", (function(e) {
                ...
                const isHeaderMain = header.classList.contains("header-main");
                if (!isHeaderMain) wrapper.style.paddingTop = headerHeight + "px";
                clearTimeout(timer);
                if (scrollTop >= startPoint) {
                    ...
                    if (!isHeaderMain) wrapper.style.paddingTop = "";
                }
        ...
        if (servicesAll) servicesAll.addEventListener("click", (function(e) {
            document.querySelector(".services").classList.toggle("services-open");
        }));
        ...
        if (btnUp) {
            ...
            window.addEventListener("scroll", (function() {
                btnUp.classList.toggle("visible", window.scrollY > 120);
            }));
        }
        const textareaOpen = document.querySelector(".txtr-js-open");
        const textareaClose = document.querySelector(".txtr-js-close");
        if (textareaOpen && textareaClose) {
            textareaOpen.addEventListener("click", (function(e) {
                const formFieldset = e.target.closest(".form__fieldset");
                if (formFieldset) {
                    const formTextarea = formFieldset.querySelector(".form__textarea");
                    if (formTextarea) formTextarea.classList.add("visible");
                    textareaOpen.classList.add("hidden");
                    textareaClose.classList.add("visible");
                }
            }));
            textareaClose.addEventListener("click", (function(e) {
                const formFieldset = e.target.closest(".form__fieldset");
                if (formFieldset) {
                    const formTextarea = formFieldset.querySelector(".form__textarea");
                    if (formTextarea) formTextarea.classList.remove("visible");
                    textareaClose.classList.remove("visible");
                    textareaOpen.classList.remove("hidden");
                }
            }));
        }
        window["FLS"] = true;
